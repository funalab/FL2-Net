...
from src.modeling.criterions.deepws_loss import SetCriterion
from src.modeling.postprocess.watershed_decode import WatershedDecoder


class DeepWatershed(nn.Module):
    """
